...
local function IsSpecialAndPerk(picker)
	return (IsSpecialEventActive(SPECIAL_EVENTS.YOTG) or (picker:HasTag("player") and picker.components.allachivcoin.festive == true))
end
...
local function onpickedfn(inst, picker)
    ...
    if not (picker:HasTag("berrythief") or inst._noperd) and math.random() < (IsSpecialAndPerk(picker) and TUNING.YOTG_PERD_SPAWNCHANCE or TUNING.PERD_SPAWNCHANCE) then
