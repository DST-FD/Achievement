...
AddModRPCHandler("DSTAchievement", "festive", function(player)
	player.components.allachivcoin:festivecoin(player)
end)
...
AddModRPCHandler("DSTAchievement", "disguise", function(player)
	player.components.allachivcoin:disguisecoin(player)
end)
